...
class Infomatsion(models.Model):
    ...
    class Meta:
        verbose_name="Men haqimda ma'lumot"
        verbose_name_plural = "Men haqimda ma'lumotlar"
...
class Service(models.Model):
    ...
    class Meta:
        verbose_name="Mening xizmatlarim"
        verbose_name_plural = "Men haqimda xizmatlarim"
...
class Document(models.Model):
    ...
    class Meta:
        verbose_name="Mening hujjatlar"
        verbose_name="Mening hujjatlarim"
